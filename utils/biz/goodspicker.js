...
module.exports = {
    number: function(t, e) {
        ...
        d.max, 1 == i && 1 == d.value && "minus" == t.target.dataset.action || i < s && "minus" == t.target.dataset.action ? o.toast(e, "单次最少购买" + d.value + "件") : d.value == d.max && "plus" == t.target.dataset.action || (console.log(e.data.stock + "....." + i), 
        e.data.stock < i ? o.toast(e, "库存不足") : e.setData({
            total: i
        }));
    },
    inputNumber: function(t, a) {
        var e = a.data.goods.maxbuy, d = a.data.goods.minbuy, i = t.detail.value;
        if (console.log(a.data.stock + "....." + i), i > 0) {
