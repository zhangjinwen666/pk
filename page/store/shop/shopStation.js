        ...
        var n = a[o];
        {
            if ("string" != typeof n.imageurl) {
                ...
                return wx.showLoading({
                    ...
                    filePath: n.showurl,
                    success: function(i) {
                        n.imageurl = i[0].data.filepath, t(a, e, s);
                    }
                });
            }
            i.push(n.imageurl);
...
function a(t, a) {
    return h.util.empty(t.shopname) ? (h.showError("请输入店铺名称"), !1) : h.util.empty(f) ? (h.showError("请选择店铺分类"), 
    !1) : h.util.empty(t.linkman) ? (h.showError("请输入联系人"), !1) : h.util.isMobile(t.shoptel) ? h.util.empty(d) ? (h.showError("请选择详细地址"), 
    ...
    !1) : 0 != a.data.shopImgList.length || (h.showError("请选添加店铺照片"), !1) : (h.showError("电话格式错误"), 
    !1);
}
...
Page({
    ...
    onLoad: function(t) {
        o(), e(this), h.util.empty(t.query) || (this.setData({
            buttonText: "确定修改"
